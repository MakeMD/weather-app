...
export default function ThemeModal({ visible, onClose, currentPreference, onSelectTheme }) {
    ...
    >
      <SafeAreaView style={styles.safeArea} edges={['top', 'bottom']}>
        ...
        <FlatList
          ...
          renderItem={({ item }) => {
            const isActive = item.code === currentPreference;
            const labelKey =
              item.code === 'auto' ? 'themeAuto'
              : item.code === 'light' ? 'themeLight'
              : 'themeDark';
            return (
              <TouchableOpacity
