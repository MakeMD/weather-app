...
- ✅ **fix(ui):** довгі назви міст ("Хмельницький", і т.д.) обрізалися крапками на вузьких пристроях типу Galaxy S21 (384dp). Додано `adjustsFontSizeToFit` + `minimumFontScale={0.75}` у CityHeader — auto-shrink спрацьовує тільки для довгих назв, короткі ("Київ", "Львів") виглядають як раніше. _components/CityHeader.js_ _(2026-05-10)_
